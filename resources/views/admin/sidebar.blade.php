<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <p class="sidebar-brand brand-logo">Cosmatics</p>
  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="{{url('opinions')}}">
        ...
        <span class="menu-title">{{__('message.opinions')}}</span>
      </a>
    </li>

    <li class="nav-item menu-items">
      <a class="nav-link" href="{{url('contacts/edit')}}">
        <span class="menu-icon">
          <i class="mdi mdi-speedometer"></i>
        </span>
        <span class="menu-title">{{__('message.contacts')}}</span>
      </a>
    </li>
